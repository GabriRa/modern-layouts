                ...
                <section className="second-section section-characteristics">
                    ...
                    <div className="characteristic-product characteristic-product-3">
                        ...
                        <div className="product-info product-options">
                            ...
                            <span className="span-transformed span-transformed-1"></span>
                            <span className="span-transformed span-transformed-2"></span>
                            <span className="span-transformed span-transformed-3"></span>
                            <span className="span-transformed span-transformed-4"></span>
                            <span className="span-transformed span-transformed-5"></span>
                        </div>
                    </div>
